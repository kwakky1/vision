...
export default function Home() {
  ...
  const input: InputData = isValidString(inputString)
  ...
  const { control, handleSubmit } = useForm<IFormInputs>({
    defaultValues: {
      ...
      birthday: isValidObject(getValidObject(input, 'birthday'))
        ? dayjs(getValidObject(input, 'birthday'))
        : null,
      ...
      full_right_add: getValidObject(input, 'full', 'right', 'add') || 0.0,
      ...
      full_left_add: getValidObject(input, 'full', 'left', 'add') || 0.0,
    },
  });
